...
// int create_descriptor_set_layout(Init &init, ComputeData &data) {
...
//   VkShaderModule compute_module = createShaderModule(init,
//   compute_shader_code);
...
// int createStorageBuffer(Init &init, ComputeData &data) {
...
//   // if (init.disp.createBuffer(&bufferInfo, nullptr, &data.storageBuffer) !=
//   // VK_SUCCESS) {
...
//   vmaCreateBuffer(allocator, &bufferInfo, &allocInfo, &data.storageBuffer,
//                   &allocation, nullptr);
